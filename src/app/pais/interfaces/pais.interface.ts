...
//
//   const rESTCountryResp = Convert.toRESTCountryResp(json);
//
...
export class Convert {
    public static toRESTCountryResp(json: string): Country[] {
        return cast(JSON.parse(json), a(r("RESTCountryResp")));
    }

    public static rESTCountryRespToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("RESTCountryResp"))), null, 2);
    }
}
